...
message(STATUS "robot_arm: 2 messages, 0 services")

set(MSG_I_FLAGS "-Irobot_arm:/home/gogochiou/NTHUproject_ws/src/robot_arm/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/gogochiou/NTHUproject_ws/src/robot_arm/msg/armCommand.msg" NAME_WE)
add_custom_target(_robot_arm_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "robot_arm" "/home/gogochiou/NTHUproject_ws/src/robot_arm/msg/armCommand.msg" ""
)

get_filename_component(_filename "/home/gogochiou/NTHUproject_ws/src/robot_arm/msg/armState.msg" NAME_WE)
add_custom_target(_robot_arm_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "robot_arm" "/home/gogochiou/NTHUproject_ws/src/robot_arm/msg/armState.msg" ""
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/robot_arm)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/robot_arm\")")
  # install generated code
  install(
